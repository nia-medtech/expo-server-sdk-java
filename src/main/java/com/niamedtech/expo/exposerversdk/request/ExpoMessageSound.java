...
public class ExpoMessageSound implements JsonSerializable {
  ...
  public ExpoMessageSound(String _name) {
    if (_name != null && !_name.equals("default")) throw new IllegalArgumentException();
  ...
  public void setVolume(long _volume) {
    ...
    if (_volume > 100) throw new IllegalArgumentException();
    volume = _volume;
  }
  ...
  public void serialize(JsonGenerator jsonGenerator, SerializerProvider serializerProvider)
    ...
    if (critical != null || volume > 0) {
      ...
      if (critical != null) jsonGenerator.writeBooleanField("critical", critical);
      if (name != null) jsonGenerator.writeStringField("name", name);
      if (volume > 0) jsonGenerator.writeNumberField("volume", volume);
