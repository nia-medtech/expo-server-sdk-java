...
import com.niamedtech.expo.exposerversdk.exception.PushClientException;
...
import com.niamedtech.expo.exposerversdk.request.ExpoMessageSound;
...
class PushClientTest {
  ...
  public void chunkListsOfPushNotificationMessages() throws PushClientException {
    ...
    List<ExpoPushMessage> messages =
        new ArrayList<>(Collections.nCopies(999, new ExpoPushMessage("?")));
  ...
  public void canChunkSmallListsOfPushNotificationMessages() throws PushClientException {
    PushClient client = new PushClient();
    List<ExpoPushMessage> messages =
        new ArrayList<>(Collections.nCopies(10, new ExpoPushMessage("?")));
    List<List<ExpoPushMessage>> chunks = client.chunkPushNotifications(messages);
  ...
  public void canChunkSinglePushNotificationMessageWithListsOfRecipients()
    ...
    List<List<ExpoPushMessage>> chunks = client.chunkPushNotifications(messages);
    chunks.stream().forEach((c) -> assertEquals(1, c.size()));
  ...
  public void canChunkSinglePushNotificatoinMessageWithSmallListsOfRecipients()
    ...
    PushClient<ExpoPushMessageCustomData<Integer>> client = new PushClient<>();
  ...
  public void isExponentPushTokenCanValidateTokens() {
    ...
    assertEquals(
        true,
        PushClient.isExponentPushToken(validToken1),
        "Test that \"ExpoPusToken[\" is a valid token");
    String validToken2 = "ExponentPushToken[xxxxxxxxxxxxxxxxxxxxxx]";
    assertEquals(
        true,
        PushClient.isExponentPushToken(validToken2),
        "Test that \"ExponentPushToken[\" is a valid token");
    String validToken3 = "F5741A13-BCDA-434B-A316-5DC0E6FFA94F";
    assertEquals(
        true,
        PushClient.isExponentPushToken(validToken3),
        "Test that \"F5741A13-BCDA-434B-A316-5DC0E6FFA94F\" is a valid token");
  ...
  public void chunkPushNotificationReceiptIdsCanChunkCorrectly() throws PushClientException {
    PushClient client = new PushClient();
    List<String> recieptIds =
        new ArrayList<>(Collections.nCopies(60, "F5741A13-BCDA-434B-A316-5DC0E6FFA94F"));
  ...
  public void chunkTwoMessagesAndOneAdditionalMessageWithNoRecipient() throws PushClientException {
    ...
    List<ExpoPushMessage> messages =
        new ArrayList<>(Collections.nCopies(2, new ExpoPushMessage("?")));
  ...
  public void chunk99MessagesAndOneAdditionalMessageWithTwoRecipients() throws PushClientException {
    PushClient client = new PushClient();
    List<ExpoPushMessage> messages =
        new ArrayList<>((Collections.nCopies(99, new ExpoPushMessage("?"))));
  ...
  public void getOneReceipt() throws InterruptedException, ExecutionException, PushClientException {
    ...
    CompletableFuture<String> mockResponseFuture =
        new CompletableFuture<>().completedFuture(SOURCE_JSON);
    ...
    List<List<String>> receiptIdChunks =
        client.chunkPushNotificationReceiptIds(
            Arrays.asList("2011eb6d-d4d3-440c-a93c-37ac4b51ea09"));
  ...
  @Test
  public void sendPushNotificationsAsyncThrowsExceptionWithAllFailedMessages()
      throws PushClientException {
    PushServerResolver pushServerResolverMock = mock(PushServerResolver.class);
    when(pushServerResolverMock.postAsync(any(), any()))
        .thenThrow(new CompletionException(new Exception("Exception!")));

    PushClient client = new PushClient();
    client.pushServerResolver = pushServerResolverMock;

    List<ExpoPushMessage> messages =
        new ArrayList<>(Arrays.asList(new ExpoPushMessage("Recipient 1")));
  ...
  @Test
  public void sendPushNotificationsReceiptAsyncThrowsExceptionWithAllFailedMessages()
      throws PushClientException {
    PushServerResolver pushServerResolverMock = mock(PushServerResolver.class);
    when(pushServerResolverMock.postAsync(any(), any()))
        .thenThrow(new CompletionException(new Exception("Exception!")));
    ...
    assertEquals(
        pushNotificationReceiptsException.ids.get(0), "2011eb6d-d4d3-440c-a93c-37ac4b51ea09");
  }

  @Test
  public void sendPushNotificationsAsyncThrowsErrorsException()
      throws InterruptedException, PushClientException {
    ...
    try {
      ...
      PushNotificationException pushNotificationException =
          (PushNotificationException) e.getCause();

      assertTrue(pushNotificationException.exception instanceof PushNotificationErrorsException);
      PushNotificationErrorsException errorsException =
          (PushNotificationErrorsException) pushNotificationException.exception;
  ...
  @Test
  public void sendPushNotificationsAsyncThrowsErrorsExceptionWithData()
      throws InterruptedException, PushClientException {
    final String RESPONSE_JSON =
        "{"
            + "    \"data\": ["
  ...
  @Test
  public void getTooManyReceiptsThrowsErrorsException()
      throws InterruptedException, PushClientException {
    final String RESPONSE_JSON =
        "{"
            + "    \"errors\": ["
    ...
    CompletableFuture<List<ExpoPushReceipt>> future =
        client.getPushNotificationReceiptsAsync(Arrays.asList("1", "2"));
    try {
      future.get();
    } catch (ExecutionException e) {
      assertTrue(e.getCause() instanceof PushNotificationReceiptsException);
      PushNotificationReceiptsException pushNotificationException =
          (PushNotificationReceiptsException) e.getCause();

      assertTrue(
          pushNotificationException.exception instanceof PushNotificationReceiptsErrorsException);
