...
class PushClientTestCustomData {
  ...
  public void chunkListsOfPushNotificationMessages() throws PushClientException {
    PushClient<ExpoPushMessageCustomData<Integer>> client = new PushClient<>();
    List<ExpoPushMessageCustomData<Integer>> messages =
        new ArrayList<>(Collections.nCopies(999, new ExpoPushMessageCustomData<>("?")));
  ...
  public void canChunkSmallListsOfPushNotificationMessages() throws PushClientException {
    PushClient<ExpoPushMessageCustomData<Integer>> client = new PushClient<>();
    List<ExpoPushMessageCustomData<Integer>> messages =
        new ArrayList<>(Collections.nCopies(10, new ExpoPushMessageCustomData<Integer>("?")));
    List<List<ExpoPushMessageCustomData<Integer>>> chunks = client.chunkPushNotifications(messages);
  ...
  public void chunkTwoMessagesAndOneAdditionalMessageWithNoRecipient() throws PushClientException {
    ...
    List<ExpoPushMessageCustomData<Integer>> messages =
        new ArrayList<>(Collections.nCopies(2, new ExpoPushMessageCustomData<>("?")));
  ...
  public void chunk99MessagesAndOneAdditionalMessageWithTwoRecipients() throws PushClientException {
    PushClient<ExpoPushMessageCustomData<Integer>> client = new PushClient<>();
    List<ExpoPushMessageCustomData<Integer>> messages =
        new ArrayList<>((Collections.nCopies(99, new ExpoPushMessageCustomData<>("?"))));
  ...
  private <T extends ExpoPushMessageCustomData<?>> long _countAndValidateMessages(
      List<List<T>> chunks) throws PushClientException {
    long totalMessageCount = 0;
    for (List<T> chunk : chunks) {
      PushClient<T> client = new PushClient<T>();
  ...
  @Test
  public void sendOnePushNotificationsAsyncThrowsExceptionWithTheFailedMessage()
      throws PushClientException {
    PushServerResolver pushServerResolverMock = mock(PushServerResolver.class);
    ...
    List<List<ExpoPushMessageCustomData<Integer>>> messageChunks =
  ...
  @Test
  public void sendManyPushNotificationsAsyncThrowsExceptionWithOnlyTheFailedMessages()
      throws PushClientException {
        ...
        .thenAnswer(
            new Answer() {
              ...
              public Object answer(InvocationOnMock invocation) {
                ...
                if (count++ % 2 == 0) {
                  CompletableFuture<String> mockResponseFuture =
                      new CompletableFuture<>().completedFuture(TICKETS_JSON);
    ...
    List<List<ExpoPushMessageCustomData<Integer>>> messageChunks =
        client.chunkPushNotifications(myMessages);
  ...
  public void filterTicketsWithStatus() throws PushClientException {
    ...
    List<ExpoPushMessageTicketPair<ExpoPushMessageCustomData<Integer>>> zipMessage =
        client.zipMessagesTickets(messages, tickets);
    List<ExpoPushMessageTicketPair<ExpoPushMessageCustomData<Integer>>> failedMessages =
        client.filterAllMessagesWithError(zipMessage, TicketError.DEVICENOTREGISTERED);
